...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{images/fuzzy-exa.png}
    \caption{Various set operations based on the previous fuzzy definitions}
\end{figure}
\paragraph{Fuzzy set complement/negation}\mbox{}\\
Let $X$ be a given set and $\mu\n\mathcal{F}(X)$, then the complement $\overline{\mu}$ can be
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{images/neg-families.png}
